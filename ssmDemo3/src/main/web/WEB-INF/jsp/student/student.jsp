...
<script type="text/javascript">
    $(function () {
        ...
        //添加展示模态框
        $("#addStudentByIdsButton").click(function () {
        ...
        $("#saveUpdateStudentModalButton").click(function () {
            ...
            $.post("${pageContext.request.contextPath}/student/updateStudent",student,
            function (data) {
                alert(data.msg);
                location.href = location.href;
            })
...
<div class="container">
    <div class="row">
        ...
        <div class="col-lg-2 col-lg-offset-2">
            ...
            <button class="btn btn-info" id="addStudentByIdsButton">添加</button>
        </div>
            ...
            <table class="table table-bordered">
                ...
                <c:forEach items="${pageInfo.list}" var="student">
                    <tr>
                        ...
                        <td>${student.age}</td>
                        <td>${student.grade3.gradeName}</td>
                        <td>
                ...
                <div class="modal-body">
                    <form class="form-horizontal" id="addStudentForm">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control" name="grade3.id" id="addStudentSelect">
                ...
                <div class="modal-body">
                    <form class="form-horizontal" id="queryStudentForm">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="grade3.id" id="queryGradeName"/>
                            </div>
                        </div>
                ...
                <div class="modal-body">
                    <form class="form-horizontal" id="updateStudentForm">
                        ...
                        <div class="form-group">
                            <label  class="col-sm-3 control-label">班级</label>
                            <div class="col-sm-8">
                                <select class="form-control" name="grade3.id" id="updateStudentSelect">
                                </select>
                            </div>
                        </div>
